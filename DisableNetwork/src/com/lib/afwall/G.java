...
public class G extends android.app.Application {
	...
	public static String[] profiles = { "AFWallPrefs", AFWALL_PROFILE + 1,
			AFWALL_PROFILE + 2, AFWALL_PROFILE + 3 };
	...
	/* global preferences */
	// public static boolean alternateStart() { return
	// gPrefs.getBoolean("alternateStart", false); }
	// public static boolean alternateStart(boolean val) {
	// gPrefs.edit().putBoolean("alternateStart", val).commit(); return val; }
	...
	public static void reloadPrefs() {
		...
		sPrefs = ctx.getSharedPreferences(AFWALL_STATUS/* sic */,
	...
	public static boolean setProfile(boolean newEnableMultiProfile,
			int newStoredPosition) {
		if (newEnableMultiProfile == enableMultiProfile()
				&& newStoredPosition == storedPosition()) {
			return false;
		}
	...
	public static void addAdditionalProfile(String profile) {
		...
		gPrefs.edit().putString(ADDITIONAL_PROFILES, builder.toString())
				.commit();
	}
	...
	public static void removeAdditionalProfile(String profileName, int position) {
		...
		if (ctx != null) {
			ctx.getSharedPreferences(sharedProfileName, 0).edit().clear()
					.commit();
		}
		String previousProfiles = gPrefs.getString(ADDITIONAL_PROFILES, "");
